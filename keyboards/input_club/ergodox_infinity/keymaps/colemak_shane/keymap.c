...
[2] = LAYOUT_ergodox(
       ...
       KC_TRNS,        M(1),         KC_7,         KC_8,       KC_9,      M(2),       KC_TRNS,
                       KC_SLSH,      KC_4,         KC_5,       KC_6,      S(KC_8),    KC_TRNS,
       KC_TRNS,        KC_MINS,      KC_1,         KC_2,       KC_3,      S(KC_EQL),  KC_PENT,
                                     KC_EQL,       KC_0,       KC_DOT,    KC_COMM,    KC_TRNS,
 ...
 * |        |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |           |  F7  |  F8  |  F9  | F10  |  F11 |  F12 |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |      | HOME |  UP  | END  |      |      |           |      |      | HOME |  UP  | END  | PGUP |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      | LEFT | DOWN |RIGHT |      |------|           |------|      | LEFT | DOWN | RGHT |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      | VOL- | MUTE | VOL+ |      |      |           |      |      | VOL+ | MUTE | VOL- | PGDN |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       |      |      |      |      |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[3] = LAYOUT_ergodox(
       ...
       KC_TRNS,        KC_TRNS,    KC_VOLU,    KC_MUTE,    KC_VOLD,    KC_PGDN,    KC_TRNS,
                                   KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,
