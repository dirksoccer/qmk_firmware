...
[LOWER_LAYER] = { /* LOWER */
  {RESET,    BL_STEP,  KC_UP,  	 KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS, KC_7,   KC_8,    KC_9,  	 KC_TRNS},
  {KC_TAB,   KC_LEFT,  KC_DOWN,  KC_RIGHT, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_PSLS, KC_4,   KC_5,    KC_6,     KC_PAST},
  {KC_LSFT,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_PMNS, KC_1,   KC_2,    KC_3,     KC_PPLS},
  {KC_LCTL,  KC_ESC,   KC_LGUI,  KC_LALT,  KC_TRNS,  KC_TRNS,   KC_BSPC,  KC_SPC,  KC_EQL, KC_0,    KC_DOT,   KC_ENT}
},
[UPPER_LAYER] = { /* RAISE */
